    ...
    <div className='container mx-auto p-4 text-gray-800 dark:text-white'>
      ...
      <form onSubmit={handleSubmit} className='space-y-4'>
        ...
        <div>
          ...
          <div className='dark:bg-gray-800 dark:border-gray-600 p-2 rounded'>
            <ReactTags
              tags={tags}
        ...
        <div>
          ...
          <input
            ...
            disabled
          />
          <img className='w-16 h-16 rounded my-4' src={user.photoURL} alt="user" />
          <input
            type="email"
            className='w-full p-2 border rounded dark:bg-gray-800 dark:border-gray-600 dark:text-white mt-2'
            value={user.email}
            disabled
          />
        </div>
